...
const addCards = () => {
    ...
    cards.forEach((card) => {
        ...
        cardAux.classList = "card position-relative"
        cardAux.style.width = "18rem";
        cardAux.innerHTML = `<i class="card-heart fa-solid fa-heart fa-2x"></i>
        ...
        cardsWrapper.appendChild(cardAux);
    })
}